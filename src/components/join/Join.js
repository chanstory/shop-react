            ...
            <div>
                ...
                <div className="border border-dark rounded joinForm">
                    ...
                    <div className="row mt-5 mb-2">
                        ...
                        <input type="text" name="joinId" id="joinId" className="form-control col-lg-5 mr-1" maxLength="15" onChange={this.handleChange} placeholder="아이디를 입력해주세요"></input>
                        <input type="button" name="duplicateCheck" className="btn btn-dark col-lg-2" value="중복체크" onClick={this.idDuplicateCheck}></input>
                    </div>
                    <div className="row mt-2 mb-2">
                        <h6 className="col-lg-4 ml-1 mb-0 align-self-center">비밀번호</h6>
                        <input type="password" name="joinPassword" className="form-control col-lg-7" maxLength="15" onChange={this.handleChange} placeholder="비밀번호를 입력해주세요"></input>
                    </div>
                    <div id="pwDupDiv" className="row">
                        <h6 className="col-lg-4 ml-1 mb-0 align-self-center">비밀번호 재확인</h6>
                        <input type="password" name="duplicatePassword" className="form-control col-lg-7" maxLength="15" onChange={this.handleChange} placeholder="비밀번호를 재입력해주세요"></input>
                    </div>
                    <div className="row mt-2 mb-2">
                        <h6 className="col-lg-4 ml-1 mb-0 align-self-center">이름</h6>
                        <input type="text" name="name" className="form-control col-lg-7" onChange={this.handleChange} placeholder="이름을 입력해주세요"></input>
                    </div>
                    <div className="row mt-2 mb-2">
                        <h6 className="col-lg-4 ml-1 mb-0 align-self-center">생년월일</h6>
                        <input type="text" name="birthDate" className="form-control col-lg-7" maxLength="8" onChange={this.handleChange} placeholder="생년월일(8자리)"></input>
                    </div>
                    <div className="row mt-2 mb-2">
                        <h6 className="col-lg-4 ml-1 mb-0 align-self-center">휴대전화(-없이입력)</h6>
                        <input type="text" name="phoneNumber" className="form-control col-lg-7" maxLength="11" onChange={this.handleChange} placeholder="전화번호를 입력해주세요"></input>
                    </div>
                    <div className="row mt-2 mb-2">
                        <h6 className="col-lg-4 ml-1 mb-0 align-self-center">주소</h6>
                        <input type="text" name="address" className="form-control col-lg-7" onChange={this.handleChange} placeholder="주소를 입력해주세요"></input>
                    </div>
                    <div className="row mt-2">
                        <h6 className="col-lg-4 ml-1 mb-0 align-self-center">이메일</h6>
                        <input type="text" name="email" className="form-control col-lg-7" onChange={this.handleChange} placeholder="이메일을 입력해주세요"></input>
                    </div>
                    <div className="text-center m-2 mt-4">
                        <input type="button" className="btn btn-dark col-lg-5" name="joinButton" value="가입하기" onClick={this.join}></input>
                    </div>
                </div>
                <Footer/>
            </div>
